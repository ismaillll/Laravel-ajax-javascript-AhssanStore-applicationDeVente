      ...
      @foreach ($four as $value)
        <tr >
          ...
          <td>
            ...
            <a href="#" class=" btn btn-warning btn-sm" data-toggle="modal" data-target="#edit" data-nom="{{$value->nom}}" data-email="{{$value->email}}" data-telephone="{{$value->telephone}}" data-fax="{{$value->fax}}" data-ville="{{$value->ville}}" data-adresse1="{{$value->adresse1}}"  data-adresse2="{{$value->adresse2}}">
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
      <script>
         jQuery(document).ready(function(){
            jQuery('#ajaxAdd').click(function(e){
               e.preventDefault();
               $.ajaxSetup({
                  headers: {
