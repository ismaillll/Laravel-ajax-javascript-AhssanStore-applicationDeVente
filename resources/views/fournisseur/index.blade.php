      ...
      <div class="box-body">
        @if(Session::has('message'))
             ...
             <button href="{{route('gstuser')}}" style='float:left' type="button" class="btn btn-danger btn-xs" data-toggle="modal" >
               ...
               <a style='color:White' href="{{route('fournisseur')}}">Retour</a></li>
             </button>
          </br>
          </br>
             @endif
    ...
    <table class="table table-bordered  table-striped" id="table">
      <tr>
        ...
        <th class="text-center" width="100px">
          ...
          <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#add">
            <i class="glyphicon glyphicon-plus"></i>
          </button>
      ...
      @foreach ($four as $value)
        <tr >
          ...
          <td  class="text-center">
            ...
            <!--<a href="#" class=" btn btn-primary btn-xs" data-toggle="modal" data-target="#show" data-nom="{{$value->nom}}" data-email="{{$value->email}}" data-telephone="{{$value->telephone}}" data-fax="{{$value->fax}}" data-ville="{{$value->ville}}" data-adresse1="{{$value->adresse1}}"  data-adresse2="{{$value->adresse2}}">
              <i class="fa fa-eye"></i>
            </a>-->
            <a href="{{action('FournisseurController@edit', $value->id)}}" class=" btn btn-warning btn-xs">
              <i class="glyphicon glyphicon-pencil"></i>
            </a>
            <a href="#" class=" btn btn-danger btn-xs" data-fourid="{{$value->id}}" data-toggle="modal" data-target="#delete">
      ...
      Affichage de {{ $four->firstItem() }} à {{ $four->lastItem() }} sur {{ $four->total() }} entrées (page {{ $four->currentPage() }} )
