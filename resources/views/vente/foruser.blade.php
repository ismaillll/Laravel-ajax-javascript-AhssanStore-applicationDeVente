...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box box-">
      ...
      <div class="box-body">
        @if(Session::has('message'))
             ...
             <button href="{{route('ventes')}}" style='float:left' type="button" class="btn btn-danger btn-xs" data-toggle="modal" >
    ...
    <table class="table table-bordered  table-striped"   id="table">
      ...
      <tbody>
        ...
        <!--  <td class="text-center" style='float:center'>
          ...
          <td class="text-center" style='float:center'>
            ...
            <a href="" class=" btn btn-danger btn-xs" data-vente_id="{{$value->id}}" data-toggle="modal" data-target="#delete">
                <i class="glyphicon glyphicon-trash"></i>
              </a>
      ...
      Affichage de {{ $foruser->firstItem() }} à {{ $foruser->lastItem() }} sur {{ $foruser->total() }} entrées (page {{ $foruser->currentPage() }} )
