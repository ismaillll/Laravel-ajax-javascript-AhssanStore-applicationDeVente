...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><span class="glyphicon glyphicon-list-alt"></span><a style="color:black;" href="{{route('gstuser')}}"> Gérer l'utilisateurs</a></small>
  ...
  <section class="content">
    ...
    <table class="table table-bordered  table-striped" id="table">
      <tr>
        <th><button  type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#ajouter">
